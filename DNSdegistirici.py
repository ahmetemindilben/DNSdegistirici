...
def yardim():
   ...
   \nBasit DNS Değiştirici aracında DNS adreslerinizi değiştirebilmeniz için iki yöntem bulunmaktadır;""")
	...
	print(renk.duzmavi + "\nNOT:" + renk.normal + " Aracı kullandığınız, sistemlerinizde barındırdığınız ve aracın hizmetlerinden yararlandığınız her durumda kullanım koşullarını kabul etmiş sayılırsınız.")
	baskaIslem()
